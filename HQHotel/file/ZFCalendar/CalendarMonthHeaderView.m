...
#define CATDayLabelWidth  [UIScreen mainScreen].bounds.size.width/8
...
- (void)setup
{
    ...
    //月份
    UILabel *masterLabel = [[UILabel alloc] initWithFrame:CGRectMake(10.f, 10.0f, WIDTH-20, 30.f)];
    ...
    xOffset += CATDayLabelWidth + WIDTH/64;
